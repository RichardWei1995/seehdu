...
public class Game01Activity extends Activity {
	...
	private GameView1 view, view1, view2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		hand = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				Integer[] num = new Integer[] { view.indexs[0] + 1,
						view1.indexs[0] + 1, view2.indexs[0] + 1 };
				Arrays.sort(num);
		...
		btn_start.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (count == 0) {
					...
					view = new GameView1(context, points.get(0), width, height,
							sp, 0, hand);
					view1 = new GameView1(context, points.get(1), width,
							height, sp, 1, hand);
					view2 = new GameView1(context, points.get(2), width,
							height, sp, 2, hand);
					...
					if (view != null && !view.flag) {// 如果上次的线程没有跑了才允许开启此次线程
						sp.play(music, 1, 1, 0, 0, 1);
						view = new GameView1(context, points.get(0), width,
								height, sp, 0, hand);
						view1 = new GameView1(context, points.get(1), width,
								height, sp, 1, hand);
						view2 = new GameView1(context, points.get(2), width,
