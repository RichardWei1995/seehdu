...
/**
 * @author jw 招聘viewpager适配器
 * 
 */
public class MyViewPagerHr extends LinearLayout {
	class TitleData {
		TextView childtitle;
		ImageView childpic;
		View childtitleview;
	...
	public MyViewPagerHr(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public MyViewPagerHr(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public MyViewPagerHr(Context context) {
		super(context);
	...
	private void init(Context context) {
		...
		fatherview = LayoutInflater.from(this.context).inflate(
				R.layout.layout_hr_sybviewpager, null);
		titleitem = (LinearLayout) fatherview
				.findViewById(R.id.Layout_hr_title);
